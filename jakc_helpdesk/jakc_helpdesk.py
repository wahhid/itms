...
pop3server = '172.16.0.129'
pop3port = '110'
pop3user  = 'ta\helpdesk'
pop3password = 'P@ssw0rd'
helpdesk_manager = 'maryland@mulialand.co.id'
helpdesk_email = 'helpdesk@taman-anggrek-mall.com'
it_support_email = 'it_support@taman-anggrek-mall.com'
reportserver = '172.16.2.49'
reportserverport = '8080'
intapprovalserver = '172.16.0.3'
            ...
            if employee:                               
                ...
                if track_id is None:
                    ...
                    if ticket:                
                        ...
                        email_data['email_to'] = it_support_email
